...
ofstream MJ_DSP("/home/myeongju/MJ_DSP.txt");
...
{   
    ...
    dsp_scaler_dot_(0) = 300.0 * stepping_err(0) - 20.0 * dsp_scaler_(0); // 300, -10
    ...
    {                  
        ...
        dsp_time_reducer_ = DyrosMath::minmax_cut(round(dsp_time_reducer_*1000)/1000.0, 0.0, 0.17);
