...
void AvatarController::computeFast()
{
    if (rd_.tc_.mode == 10)
    {
        if (initial_flag == 1)
        {
            ...
            loadLstmWeights(left_leg_mob_lstm_, "/home/dyros/catkin_ws/src/tocabi_avatar/lstm_tocabi/weights/left_leg/left_leg_tocabi_tracker_vel_ft_mix1/");
            loadLstmMeanStd(left_leg_mob_lstm_, "/home/dyros/catkin_ws/src/tocabi_avatar/lstm_tocabi/mean_std/left_leg/left_leg_tocabi_tracker_vel_ft_mix1/");

            initializeLegLSTM(right_leg_mob_lstm_);
            loadLstmWeights(right_leg_mob_lstm_, "/home/dyros/catkin_ws/src/tocabi_avatar/lstm_tocabi/weights/right_leg/right_leg_tocabi_tracker_vel_ft_mix1/");
            loadLstmMeanStd(right_leg_mob_lstm_, "/home/dyros/catkin_ws/src/tocabi_avatar/lstm_tocabi/mean_std/right_leg/right_leg_tocabi_tracker_vel_ft_mix1/");
            initial_flag = 2;
        }
    }
    else if (rd_.tc_.mode == 11)
...
void AvatarController::collisionIsolation()
{
    ...
    if (left_leg_collision_detected_link_ != 0 && left_leg_collision_detected_link_ != 6 && check_left_swing_foot_ && estimated_ext_force_lfoot_lstm_(2) < foot_normal_force_threshold)
    {
        ...
        if (left_leg_collision_cnt_[0] >= continuous_filter_window || left_leg_collision_cnt_[1] >= continuous_filter_window)
        {
    ...
    if (right_leg_collision_detected_link_ != 0 && right_leg_collision_detected_link_ != 6 && check_right_swing_foot_ && estimated_ext_force_rfoot_lstm_(2) < foot_normal_force_threshold)
    {
        ...
        if (right_leg_collision_cnt_[0] >= 5 || right_leg_collision_cnt_[1] >= 5)
        {
            ...
            if (collision_detection_flag_ == false)
            {
                ...
                // calculateFootStepTotal_reactive(rfoot_support_current_.translation()(0) - 0.03, true);
                // collision_detection_flag_ = true;
            }
