...
{    
    ...
    Eigen::VectorXd p(N+future_step_num_);
    ...
    QP_mpc_y.EnableEqualityCondition(equality_condition_eps_); 
    QP_mpc_y.UpdateMinProblem(Q_mpc,p); 
    QP_mpc_y.DeleteSubjectToAx();       
