        ...
        if (walking_enable_ == true) //31~180us
        {
            ...
            if (current_step_num_ < total_step_num_)
            {
                ...
                for (int i = 0; i < 12; i++)
                {
                    ...
                    if( estimated_model_unct_torque_variance_slow_(i) == 0 )
                    {
                        p_gaussian(i) = 1.0;
                    ...
                    // torque_lower_(i) -= first_smoothing_gain*0.3*estimated_model_unct_torque_slow_lpf_(i);
...
void AvatarController::computeFast()
{
    if (rd_.tc_.mode == 10)
    {
        if (initial_flag == 1)
        {
            ...
            loadLstmWeights(left_leg_mob_lstm_, "/home/dyros/catkin_ws/src/tocabi_avatar/lstm_tocabi/weights/left_leg/left_leg_tocabi_tracker_vel_des_torque_mob_sub_ft_mix1_gaussian/");
            loadLstmMeanStd(left_leg_mob_lstm_, "/home/dyros/catkin_ws/src/tocabi_avatar/lstm_tocabi/mean_std/left_leg/left_leg_tocabi_tracker_vel_des_torque_mob_sub_ft_mix1_gaussian/");

            initializeLegLSTM(right_leg_mob_lstm_);
            loadLstmWeights(right_leg_mob_lstm_, "/home/dyros/catkin_ws/src/tocabi_avatar/lstm_tocabi/weights/right_leg/right_leg_tocabi_tracker_vel_des_torque_mob_sub_ft_mix1_gaussian/");
            loadLstmMeanStd(right_leg_mob_lstm_, "/home/dyros/catkin_ws/src/tocabi_avatar/lstm_tocabi/mean_std/right_leg/right_leg_tocabi_tracker_vel_des_torque_mob_sub_ft_mix1_gaussian/");
            initial_flag = 2;
        }
    }
    else if (rd_.tc_.mode == 11)
...
void AvatarController::collectRobotInputData_acc_version()
{
    ...
    /////////left leg mob lstm//////////////////
    left_leg_mob_lstm_.robot_input_data(0) = 1;   //quat
    left_leg_mob_lstm_.robot_input_data(1) = 0;
    left_leg_mob_lstm_.robot_input_data(2) = 0;
    left_leg_mob_lstm_.robot_input_data(3) = 0;

    left_leg_mob_lstm_.robot_input_data(4) = ref_q_(0);    //q
    left_leg_mob_lstm_.robot_input_data(5) = ref_q_(1);
    left_leg_mob_lstm_.robot_input_data(6) = ref_q_(2);
    left_leg_mob_lstm_.robot_input_data(7) = ref_q_(3);
    left_leg_mob_lstm_.robot_input_data(8) = ref_q_(4);
    left_leg_mob_lstm_.robot_input_data(9) = ref_q_(5);
    
    left_leg_mob_lstm_.robot_input_data(10) = 0;    //pelv ang vel
    left_leg_mob_lstm_.robot_input_data(11) = 0;
    left_leg_mob_lstm_.robot_input_data(12) = 0;

    left_leg_mob_lstm_.robot_input_data(13) = ref_q_dot_(0);   // qdot
    left_leg_mob_lstm_.robot_input_data(14) = ref_q_dot_(1);
    left_leg_mob_lstm_.robot_input_data(15) = ref_q_dot_(2);
    left_leg_mob_lstm_.robot_input_data(16) = ref_q_dot_(3);
    left_leg_mob_lstm_.robot_input_data(17) = ref_q_dot_(4);
    left_leg_mob_lstm_.robot_input_data(18) = ref_q_dot_(5);
    ...
    left_leg_mob_lstm_.robot_input_data(25) = xd_mj_(2);    //lin acc
    left_leg_mob_lstm_.robot_input_data(26) = yd_mj_(2);
    left_leg_mob_lstm_.robot_input_data(27) = 0;
